...
function createPolyLine(map, maps, coordinate1, coordinate2){
    ...
    var offset1 = maps.geometry.spherical.computeOffset(p1, lineLength/2, lineHeading - 45)
    var offset2 = maps.geometry.spherical.computeOffset(p2, lineLength/2, - lineHeading + 45 )
    
    var BezierLine = new GmapsCubicBezier(p1, p1, p2, p2, constants.resolution, map, maps);
    return BezierLine
}
...
// doesnt work for spherical coordinates for longer distance
